...
export function initMobileMenu() {
  ...
  const toggleMenu = () => {
    ...
    menuToggle.setAttribute('aria-label', newState ? 'Fermer le menu' : 'Ouvrir le menu');
  ...
  const submenuTriggers = mobileMenu.querySelectorAll('[data-mobile-submenu-trigger]');
  ...
  const mobileLinks = mobileMenu.querySelectorAll('.header__mobile-sublink, .header__mobile-link--cta');
